...
export default function Home() {
  return (
    <div className=" bg-secondary px-10 py-20">
      <h1 className="text-xl text-center font-extrabold">
        Need a sweet treat? We got you covered!
      </h1>
      <p>
        Our baked goods are fully Halal and we carry a range of Vegan and GF
        products. In case you cannot find what you&apos;re looking for, email us
        and we can customize to your needs
      </p>
      <p>
